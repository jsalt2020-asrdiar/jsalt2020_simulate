...
# Directories
# Takuya's set-up
srcdir=/data/tayoshio/jsalt2020_simulate/data/train/wav_newseg  # Generated by preprocess.sh.
tgtroot=/data/tayoshio/jsalt2020_simulate/data/LibriCSS-train-default
