...
def make_argparse():
    ...
    parser.add_argument('--srcdir', metavar='PATH', nargs='+', required=True, 
    ...
    parser.add_argument('--include_filter', nargs='*', metavar='STR', default=['*.wav', '*.WAV'],
    ...
    parser.add_argument('--exclude_filter', nargs='*', metavar='STR', default=[], 
